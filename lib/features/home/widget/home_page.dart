      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            const Gap(8),
            // Just the brand name. The upstream version badge
            // (AppVersionLabel) overflowed the title row on narrow
            // screens — the yellow/black "OVERFLOWED" stripes the tester
            // saw — and isn't useful to end users anyway.
